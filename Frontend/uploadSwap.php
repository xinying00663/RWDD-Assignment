...
<body data-page="swap-upload">
    ...
    <main>
        <section class="tabs-card upload-card">
            ...
            <form class="upload-form" action="php/uploadSwap.php" method="post" enctype="multipart/form-data">
                ...
                <div class="upload-form__footer">
                    ...
                    <div class="upload-form__actions">
                        <button type="button" class="button-cancel" onclick="window.location.href='swapPage.php'">Cancel</button>
